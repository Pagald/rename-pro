...
async def donatecm(bot,message):
	...
	keybord = InlineKeyboardMarkup([
        			[InlineKeyboardButton("🦋 Admin",url = "https://t.me/husen751"), 
...
async def home_callback_handler(bot, query):
    ...
    keybord = InlineKeyboardMarkup([  
                    [InlineKeyboardButton("📢 Updates", url="https://t.me/+1XCWf7BcYjA5N2Fk"),
                    InlineKeyboardButton("💬 Support", url="https://t.me/+1XCWf7BcYjA5N2Fk")],
